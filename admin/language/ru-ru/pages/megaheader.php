...
//Text
$_['text_list']         	 = 'Список заголовков Mega';
...
$_['entry_patternimage']     = 'Фон шаблона';
...
$_['button_setting']         = 'Настройка заголовка Mega';
$_['button_cancel']          = 'Canel';
$_['text_success']           = 'Успех: вы изменили заголовки Mega! ';
$_['button_custom']          = 'Добавить пользовательское меню';

$_['text_product1']          = 'Продукт';
$_['text_subcategory']       = 'Подкатегория';
$_['text_price']         	 = 'Цена';
$_['text_pname']         	 = 'наименование товара';
$_['text_image']         	 = 'Образ';
$_['text_model']        	 = 'Модель';
$_['text_upc']        	     = 'СКП';
$_['text_sku']         		 = 'SKU';
...
$_['entry_description']      = 'Мегамену Описание';
...
$_['entry_showicon']		 = 'Включить значок';

// column_edit
$_['column_title']           = 'Заголовок пользовательского заголовка';
$_['column_sort_order']      = 'Порядок сортировки';
$_['column_status']          = 'Положение дел';
$_['column_edit']            = 'действие';

 // Error
$_['error_title']      		 = 'Название должно быть от 3 до 21 символа'; 
$_['error_image']      		 = 'Выберите изображение'; 
